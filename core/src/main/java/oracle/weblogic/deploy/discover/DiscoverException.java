 ...
 */
public class DiscoverException extends BundleAwareException {
     ...
     */
    public DiscoverException(String messageID) {
        super(messageID);
    }
     ...
     */
    public DiscoverException(String messageID, Object... params) {
     ...
     */
    public DiscoverException(String messageID, Throwable cause) {
     ...
     * @param params    the parameters to use to fill in the message tokens
     */
    public DiscoverException(String messageID, Throwable cause, Object... params) {
