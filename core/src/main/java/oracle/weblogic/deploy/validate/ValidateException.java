 ...
 */
public class ValidateException extends BundleAwareException {
     ...
     */
    public ValidateException(String messageID) {
        super(messageID);
    }
     ...
     */
    public ValidateException(String messageID, Object... params) {
     ...
     */
    public ValidateException(String messageID, Throwable cause) {
     ...
     * @param params    the parameters to use to fill in the message tokens
     */
    public ValidateException(String messageID, Throwable cause, Object... params) {
