...
public class ExtractDatabaseWalletCommand extends ExtractTypeCommandBase {
    ...
    @Option(
        names = {"-name"},
        description = "Name of the database wallet to be extracted from the archive file",
        required = true
    )
    private String name;
    ...
    public CommandResponse call() throws Exception {
        ...
        try {
            ...
            this.archive.extractDatabaseWalletForArchiveHelper(this.name, this.targetDirectory);
