...
@Command(
    ...
    description = "%nList domain bin script entries in the archive file:",
    sortOptions = false
)
public class ListDomainBinScriptCommand extends ListTypeCommandBase {
    ...
    @Option(
        names = { "-name" },
        paramLabel = "<name>",
        description = "Name of the domain bin script to list"
    )
    private String name;
    ...
    public CommandResponse call() throws Exception {
        ...
        CommandResponse response = listType(DOMAIN_BIN, "domain bin script", name);
