...
public class ExtractNodeManagerKeystoreCommand extends ExtractTypeCommandBase {
    ...
    @Option(
        names = {"-name"},
        description = "Name of the node manager keystore to be extracted from the archive file",
        required = true
    )
    private String name;
    ...
    @Option(
        names = { "-help" },
        description = "Get help for the archiveHelper extract nodeManagerKeystore subcommand",
        usageHelp = true
    )
    ...
    public CommandResponse call() throws Exception {
        ...
        try {
            ...
            this.archive.extractNodeManagerKeystore(this.name, this.targetDirectory);
