...
@Command(
    ...
    header = "Extract structured application installation directory from the archive file.",
    description = "%nCommand-line options:",
    sortOptions = false
)
public class ExtractStructuredApplicationCommand extends ExtractTypeCommandBase {
    private static final String CLASS = ExtractStructuredApplicationCommand.class.getName();
    ...
    @Option(
        names = {"-name"},
        description = "Name of the structured application installation directory to be extracted from the archive file",
        required = true
    )
    private String name;
    ...
    @Option(
        names = { "-help" },
        description = "Get help for the archiveHelper extract structuredApplication subcommand",
        usageHelp = true
    )
    ...
    public CommandResponse call() throws Exception {
        ...
        try {
            ...
            this.archive.extractStructuredApplication(this.name, this.targetDirectory);
