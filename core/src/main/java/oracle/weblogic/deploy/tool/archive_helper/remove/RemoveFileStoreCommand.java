...
public class RemoveFileStoreCommand extends RemoveTypeCommandBase {
    ...
    @Option(
        names = {"-name"},
        description = "Name of the File Store directory to be removed from the archive file",
        required = true
    )
    private String name;
    ...
    public CommandResponse call() throws Exception {
        ...
        try {
            ...
            int entriesRemoved;
            if (this.force) {
                entriesRemoved = this.archive.removeFileStoreDirectory(this.name, true);
            } else {
                entriesRemoved = this.archive.removeFileStoreDirectory(this.name);
            }
