...
public class ExtractDomainLibraryCommand extends ExtractTypeCommandBase {
    ...
    @Option(
        names = {"-name"},
        description = "Name of the $DOMAIN_HOME/lib library to be extracted from the archive file",
        required = true
    )
    private String name;
    ...
    public CommandResponse call() throws Exception {
        ...
        try {
            ...
            this.archive.extractDomainLibLibrary(this.name, this.targetDirectory, true);
