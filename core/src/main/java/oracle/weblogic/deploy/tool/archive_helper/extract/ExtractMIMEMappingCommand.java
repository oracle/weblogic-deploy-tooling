...
public class ExtractMIMEMappingCommand extends ExtractTypeCommandBase {
    ...
    private static final String TYPE = "MIME mapping file";
    private static final String ERROR_KEY = "WLSDPLY-30047";

    @Option(
        names = {"-name"},
        description = "Name of the MIME mapping file to be extracted from the archive file",
        required = true
    )
    private String name;
    ...
    @Option(
        names = { "-help" },
        description = "Get help for the archiveHelper extract mimeMapping subcommand",
        usageHelp = true
    )
    ...
    public CommandResponse call() throws Exception {
        ...
        try {
            ...
            this.archive.extractMimeMappingFile(this.name, this.targetDirectory);
