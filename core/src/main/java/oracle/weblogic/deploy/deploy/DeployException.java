 ...
 */
package oracle.weblogic.deploy.deploy;

import oracle.weblogic.deploy.exception.BundleAwareException;
import oracle.weblogic.deploy.exception.ExceptionHelper;

/**
 * The exception used by the deploy apps and resources components.
 */
public class DeployException extends BundleAwareException {
     ...
     */
    public DeployException(String messageID) {
        super(messageID);
    }
     ...
     */
    public DeployException(String messageID, Object... params) {
     ...
     */
    public DeployException(String messageID, Throwable cause) {
     ...
     * @param params    the parameters to use to fill in the message tokens
     */
    public DeployException(String messageID, Throwable cause, Object... params) {
