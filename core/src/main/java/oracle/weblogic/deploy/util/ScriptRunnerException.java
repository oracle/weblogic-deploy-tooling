...
/**
 * The exception used by the external script runner and process handler components.
 */
public class ScriptRunnerException extends BundleAwareException {
     ...
     */
    public ScriptRunnerException(String messageID) {
        super(messageID);
    }
     ...
     */
    public ScriptRunnerException(String messageID, Object... params) {
     ...
     */
    public ScriptRunnerException(String messageID, Throwable cause) {
     ...
     * @param params    the parameters to use to fill in the message tokens
     */
    public ScriptRunnerException(String messageID, Throwable cause, Object... params) {
