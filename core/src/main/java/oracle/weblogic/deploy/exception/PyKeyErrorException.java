...
/**
 * The exception used for python key errors.
 */
public class PyKeyErrorException extends PyBaseException {
    private static final long serialVersionUID = 1L;

    /**
     * Constructs a default exception.
     */
    public PyKeyErrorException() {
        // default constructor
    }
     ...
     */
    public PyKeyErrorException(String messageID) {
        super(messageID);
    }
     ...
     */
    public PyKeyErrorException(String messageID, Object... params) {
     ...
     */
    public PyKeyErrorException(String messageID, Throwable cause) {
     ...
     * @param params    the parameters to use to fill in the message tokens
     */
    public PyKeyErrorException(String messageID, Throwable cause, Object... params) {
     ...
     * @param cause the exception that triggered the creation of this exception
     */
    public PyKeyErrorException(Throwable cause) {
        super(cause);
    }
}
