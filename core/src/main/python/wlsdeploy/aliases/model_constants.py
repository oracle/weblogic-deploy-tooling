...
RCU_CONFIGURATION = 'RCUConfiguration'
...
RCU_CONNECTION_PROPERTIES = 'connectionProperties'
RCU_VARIABLES = 'rcu_variables'
RCU_TNS_ALIAS = 'wallet_tns_alias'
DATABASE_TYPE = 'databaseType'
ORACLE_DATABASE_PARAMS = 'oracleDatabaseParams'
MULTIDATASOURCE_URLS = "multiDataSource"
USE_ATP = 'useATP'
