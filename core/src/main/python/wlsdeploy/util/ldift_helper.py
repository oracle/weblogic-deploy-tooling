...
class LdiftBase(object):
    ...
    def __init__(self, exception_type=ExceptionType.DISCOVER):
    ...
    def read_ldift_file(self, ldift_file_name):
        ...
        for line in all_lines:
            # FIXME - LDIFT files support line continuation by starting the following line with a single space.
    ...
    def load_provider_defaults_file(self, provider_type, file_name):
        ...
        if defaults_input_stream is None:
            ex = exception_helper.create_exception(self._exception_type, 'WLSDPLY-07106', defaults_file_path)
            _logger.throwing(ex, class_name=self.__class_name, method_name=_method_name)
            raise ex
        ...
        try:
            ...
            ex = exception_helper.create_exception(self._exception_type, 'WLSDPLY-07107', provider_type,
