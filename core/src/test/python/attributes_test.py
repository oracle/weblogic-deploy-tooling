...
class AttributesTestCase(unittest.TestCase):
    ...
    def test_attribute_names(self):
        ...
        for folder_name in aliases.get_model_top_level_folder_names():
            ...
            model_token = aliases.get_name_token(location)
            if model_token is not None:
                location.add_name_token(model_token, 'foobar')
    ...
    def _check_folder(self, name, location, aliases):
        ...
        if not _is_filtered_folder(name, location) and wlst_name != name:
            message = _format(_FOLDER_MISMATCH_MSG, name, location.get_folder_path(), wlst_name)
        ...
        for key in attr_infos.keys():
            ...
            if wlst_key is not None and wlst_key != key:
                message = _format(_ATTR_MISMATCH_MSG, key, location.get_folder_path(), wlst_key)
