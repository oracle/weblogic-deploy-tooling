...
class WindowsPathHelperTestCase(unittest.TestCase):
    """
    Local Windows file system path only test class.
    """

    def setUp(self):
        self.name = 'WindowsPathHelperTestCase'
        path_helper.initialize_path_helper(ExceptionType.SSH, unit_test_force=True, unit_test_is_windows=True)
    ...
    def testLocalJoin(self):
        ...
        actual = self.path_helper.local_join(self.root_directory, arg1, arg2, arg3)
        self.assertEquals(actual, expected)
    ...
    def testFixupLocalPath_WithAbsolutePathAndForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = source_path
    ...
    def testFixupLocalPath_WithRelativePathAndForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        expected = source_path
    ...
    def testFixupLocalPath_WithAbsolutePathAndForwardSlashesAndRelativeTo(self):
        source_path = 'c:/foo/bar/baz.yaml'
        relative_to = 'd:/domains/mydomain'
        expected = source_path
    ...
    def testFixupLocalPath_WithRelativePathAndForwardSlashesAndRelativeTo(self):
        source_path = 'bar/baz.yaml'
        relative_to = 'd:/domains/mydomain'
        expected = relative_to + '/' + source_path
    ...
    def testGetLocalCanonicalPath_WithAbsolutePathAndForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = source_path.replace('/', '\\')
    ...
    def testGetLocalCanonicalPath_WithAbsolutePathAndRelativeToAndForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        relative_to = 'd:/u01'
        expected = source_path.replace('/', '\\')
    ...
    def testGetLocalCanonicalPath_WithRelativePathAndRelativeToAndForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        relative_to = 'c:/foo'
        expected = (relative_to + '/' + source_path).replace('/', '\\')
    ...
    def testGetLocalCanonicalPath_WithPathWithDotsAndForwardSlashes(self):
        source_path = 'c:/foo/./bar/../bar/baz.yaml'
        expected = 'c:\\foo\\bar\\baz.yaml'
    ...
    def testGetLocalParentDirectory_WithAbsoluteFilePathAndForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = 'c:/foo/bar'
    ...
    def testIsAbsoluteLocalPath_WithAbsolutePathWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = True
    ...
    def testIsAbsoluteLocalPath_WithRelativePathWithForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        expected = False
    ...
    def testIsRelativeLocalPath_WithAbsolutePathWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = False
    ...
    def testIsRelativeLocalPath_WithRelativePathWithForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        expected = True
    ...
    def testGetLocalFilenameFromPath_WithAbsolutePathWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = 'baz.yaml'
    ...
    def testGetLocalFilenameFromPath_WithRelativePathWithForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        expected = 'baz.yaml'
    ...
    def testGetLocalFilenameFromPath_WithFileWithNoExtWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz'
        expected = 'baz'
    ...
    def testGetLocalPathnameFromPath_WithAbsolutePathWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = 'c:/foo/bar'
    ...
    def testGetLocalPathnameFromPath_WithRelativePathWithForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        expected = 'bar'
    ...
    def testGetLocalFilenameNoExtFromPath_WithAbsolutePathWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = 'baz'
    ...
    def testGetLocalFilenameNoExtFromPath_WithRelativePathWithForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        expected = 'baz'
    ...
    def testGetLocalFilenameNoExtFromPath_WithFileWithNoExtWithForwardSlashes(self):
        source_path =  'c:/foo/bar/baz'
        expected = 'baz'
    ...
    def testIsLocalJarFile_WithAbsolutePathToJarFileWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.jar'
        expected = True
    ...
    def testIsLocalJarFile_WithRelativePathToJarFileWithForwardSlashes(self):
        source_path = 'bar/baz.jar'
        expected = True
    ...
    def testIsLocalJarFile_WithAbsolutePathToYamlFileWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = False
    ...
    def testIsLocalJarFile_WithRelativePathToYamlFileWithForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        expected = False
