...
class WindowsToPosixPathHelperTestCase(unittest.TestCase):
    """
    Remote Posix file system path only test class.
    """

    def setUp(self):
        self.name = 'WindowsToPosixPathHelperTestCase'
        path_helper.initialize_path_helper(ExceptionType.SSH, unit_test_force=True, unit_test_is_windows=True)
        path_helper.set_remote_file_system_from_oracle_home('/u01/oracle/wls12213')
    ...
    def testRemoteJoin(self):
        ...
        actual = self.path_helper.remote_join(base_dir, arg1, arg2, arg3)
        self.assertEquals(actual, expected)
    ...
    def testLocalBasename_WithAbsoluteFilePathWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz.yaml'
        expected = 'baz.yaml'
    ...
    def testLocalBasename_WithAbsoluteDirectoryPathWithForwardSlashes(self):
        source_path = 'c:/foo/bar/baz'
        expected = 'baz'
    ...
    def testLocalBasename_WithRelativeFilePathWithForwardSlashes(self):
        source_path = 'bar/baz.yaml'
        expected = 'baz.yaml'
    ...
    def testLocalBasename_WithRelativeDirectoryPathWithForwardSlashes(self):
        source_path = 'bar/baz'
        expected = 'baz'
