...
usage() {
  ...
  echo ""
  echo "        admin_pass_file  - An alternative to entering the admin password at a prompt. The value "
  echo "                          ENVIRONMENT VARIABLE name that WDT will use to retrieve the password. "
  echo ""
  echo "        admin_pass_env  - An alternative to entering the admin password at a prompt. The value "
  echo "                          ENVIRONMENT VARIABLE name that WDT will use to retrieve the password. "
  echo ""
