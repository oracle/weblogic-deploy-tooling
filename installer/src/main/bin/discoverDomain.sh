...
usage() {
  ...
  echo ""
  echo "        remote          - Online only. Discover the remote domain. Do not generate the archive file. "
  echo "                          The file references in the model will generated as archive file names for ease of use"
  echo ""
