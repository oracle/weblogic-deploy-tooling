...
#
#     NAME
#       doGenerateOnline.sh - Alias integration test script to generate MBeam JSON
#
#     DESCRIPTION
#       This script looks at the domain MBeans for a specific version of WebLogic server in
#       online mode and generates a JSON file for the domain MBeans and attributes.
#
