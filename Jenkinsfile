       ...
       stage ('Alias Test') {
            ...
            matrix {
                ...
                axes {
                    axis {
                        name 'WLS_VERSION'
                        values '12.2.1.0.0', '12.2.1.1.0', '12.2.1.2.0', '12.2.1.3.0', '12.2.1.4.0', '14.1.1.0.0', '14.1.2.0.0'
                    }
                }
                stages {
                    stage('Test') {
                        agent {
                            docker {
                                ...
                                args '--name=alias-test -u jenkins -v /var/run/docker.sock:/var/run/docker.sock'
                            }
                        }
                        steps {
