...
| `-domain_home`                        | The location of the existing local domain home.                                                                                                                                                                                                                                                       |                                            |
...
| `-remote_domain_home`                 | The fully-qualified path to the domain home on the remote machine (used for SSH and `-remote` operations).                                                                                                                                                                                            |                                            |
