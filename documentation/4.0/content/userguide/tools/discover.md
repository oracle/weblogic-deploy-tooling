...
| `-domain_home`                 | (Required for offline operation).  The location of the existing domain home.                                                                                                   | For online mode, the server's value.       |
...
| `-remote_oracle_home`          | Home directory of the Oracle WebLogic installation on the remote machine.                                                                                                      |                                            |
